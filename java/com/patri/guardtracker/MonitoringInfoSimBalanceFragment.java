 ...
 * Use the {@link MonitoringInfoSimBalanceFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MonitoringInfoSimBalanceFragment extends Fragment implements OnChartGestureListener, OnChartValueSelectedListener {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "guardTrackerId";
    private static final String ARG_PARAM2 = "lowerLimit";
    private static final String TAG = MonitoringInfoSimBalanceFragment.class.getSimpleName();

    // TODO: Rename and change types of parameters
    private int mGuardTrackerId;
    private ArrayList<String> mTimeDataSet = new ArrayList<String>();
    private ArrayList<Entry> mSimBalanceDataSet = new ArrayList<Entry>();
    private LineChart mChart;
    private double mLowerLimit;

    public MonitoringInfoSimBalanceFragment() {
     ...
     * @return A new instance of fragment MonitoringInfoSimBalanceFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MonitoringInfoSimBalanceFragment newInstance(int guardTrackerId, double lowerLimit) {
        MonitoringInfoSimBalanceFragment fragment = new MonitoringInfoSimBalanceFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mGuardTrackerId = 0;
            mLowerLimit = 0.5; // Default lower limit: € 0.50
        }

        ArrayList<MonitoringInfo> monInfoList = MonitoringInfo.readList(getContext(), mGuardTrackerId);

        mTimeDataSet.clear();
        mSimBalanceDataSet.clear();
        int i = 0;

        for (MonitoringInfo monInfo: monInfoList) {

            if (monInfo.hasSimBalance()) {
                double simBalance = monInfo.getSimBalance();
                mSimBalanceDataSet.add(new Entry((float) simBalance, i));
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sim_balance_info, container, false);
        // Continue creating the graph...
        mChart = (LineChart)view.findViewById(R.id.simBalanceChart);
...
//        LimitLine ll1 = new LimitLine(f/*threshold temperature high*/, "Upper Limit");
//        ll1.setLineWidth(4f);
...
//        leftAxis.addLimitLine(ll1);
        ...
        // add data
        setData(mSimBalanceDataSet, mTimeDataSet);
...
//        mChart.invalidate();
    ...
    private void setData(ArrayList<Entry> simBalanceDataSet, ArrayList<String> timeDataSet) {
...
//        } else {
        ...
        set1 = new LineDataSet(simBalanceDataSet, getString(R.string.sim_balance_line_legend_sim_balance_info));
