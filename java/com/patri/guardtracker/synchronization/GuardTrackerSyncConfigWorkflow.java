 ...
 */
public class GuardTrackerSyncConfigWorkflow implements BleMessageListener {
    private final static String TAG = GuardTrackerSyncConfigWorkflow.class.getSimpleName();

    private GuardTrackerSyncConfigListener mListener;
            ...
            new BleAnswProcessor() { // 6: Read secondary contact
                ...
                public void processBleAnsw(byte[] answ) {
                    if (answ[1] == GuardTrackerCommands.CmdResValues.CMD_RES_OK.value()) {
                        ...
                        mBleCtrl.removeMessageListener(GuardTrackerSyncConfigWorkflow.this);
                    }
                }
            }
    };

    public GuardTrackerSyncConfigWorkflow(GuardTrackerBleConnControl bleCtrl, GuardTrackerSyncConfigListener listener) {
        mListener = listener;
        mBleCtrl = bleCtrl;
