...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_RECONNECTED =
                ...
                if (status == 133) {
                    ...
                    mHandler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try {
                                mBluetoothGatt = (BluetoothGatt) connectGattMethod.invoke(device, BluetoothLeService.this, false, mGattCallback, BluetoothDevice.TRANSPORT_LE);
                                //                        mBluetoothGatt.requestConnectionPriority(BluetoothGatt.CONNECTION_PRIORITY_LOW_POWER);
                                //                    mBluetoothGatt = (BluetoothGatt) connectGattMethod.invoke(mBluetoothDevice, BluetoothLeService.this, true, mGattCallback, BluetoothDevice.TRANSPORT_LE);
                                // fazer refresh à cache chamando o resfresh. Ver: http://stackoverflow.com/questions/22596951/how-to-programmatically-force-bluetooth-low-energy-service-discovery-on-android
                                //refreshDeviceCache(mBluetoothGatt);
                                // Vi um comentário desagradável que referia que não funcionava para o S5 derivado à costumização que faziam na implementação do seu stack BLE.
...
//    }
    ...
    public boolean onUnbind(Intent intent) {
        ...
        mBindCountRef -= 1;
        Log.i(TAG, "onUnbind: mBindCountRef = " + mBindCountRef + ". --> close()");
        close();
    ...
    public boolean initialize() {
        ...
        // Initiate a new Handler to put async operations
        if (mHandler == null) {
    ...
    public boolean connect(final String address) {
        ...
        // Previously connected mBluetoothDevice.  Try to reconnect.
...
//                mConnectionState = STATE_CONNECTING;
                ...
                String intentAction = ACTION_GATT_RECONNECTED;
                broadcastUpdate(intentAction);
                return true;
            } else {
                return false;
        ...
        final BluetoothDevice mBluetoothDevice = mBluetoothAdapter.getRemoteDevice(address);
...
//
//            try {
//                mBluetoothGatt = (BluetoothGatt) connectGattMethod.invoke(mBluetoothDevice, this, false, mGattCallback, BluetoothDevice.TRANSPORT_LE);
//            } catch (IllegalAccessException e) {
//                e.printStackTrace();
//            } catch (IllegalArgumentException e) {
//                e.printStackTrace();
...
////        }
        ...
        // We want to directly connect to the mBluetoothDevice, so we are setting the autoConnect
        // parameter to false.
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    mBluetoothGatt = (BluetoothGatt) connectGattMethod.invoke(mBluetoothDevice, BluetoothLeService.this, false, mGattCallback, BluetoothDevice.TRANSPORT_LE);
//                    mBluetoothGatt.requestConnectionPriority(BluetoothGatt.CONNECTION_PRIORITY_LOW_POWER);
//                    mBluetoothGatt = (BluetoothGatt) connectGattMethod.invoke(mBluetoothDevice, BluetoothLeService.this, true, mGattCallback, BluetoothDevice.TRANSPORT_LE);
                    // fazer refresh à cache chamando o resfresh. Ver: http://stackoverflow.com/questions/22596951/how-to-programmatically-force-bluetooth-low-energy-service-discovery-on-android
                    //refreshDeviceCache(mBluetoothGatt);
                ...
                //mBluetoothGatt = mBluetoothDevice.connectGatt(BluetoothLeService.this, false, mGattCallback);
