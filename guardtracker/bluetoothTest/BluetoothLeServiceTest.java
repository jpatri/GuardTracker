...
public class BluetoothLeServiceTest extends Service {
    private final static String TAG = BluetoothLeServiceTest.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        BluetoothLeServiceTest getService() {
            return BluetoothLeServiceTest.this;
        }
    }
...
//        if(TTTUtilities.isLollipopOrAbove()) {
            ...
            try {
                mBluetoothGatt = (BluetoothGatt) connectGattMethod.invoke(device, this, false, mGattCallback, /*TRANSPORT_LE*/2);
