 ...
 * Bluetooth LE API.
 */
public class GuardTrackerBleControlActivity extends AppCompatActivity
                                            implements DialogListener,
        BleConnectionStateChangeListener,
        BleMessageListener,
        GuardTrackerSyncConfigListener
{
    private final static String TAG = GuardTrackerBleControlActivity.class.getSimpleName();

    public static final String EXTRAS_DEVICE_NAME = "GuardTrackerBleControlActivity.DEVICE_NAME";
    public static final String EXTRAS_DEVICE_ADDRESS = "GuardTrackerBleControlActivity.DEVICE_ADDRESS";
    public static final String EXTRAS_DEVICE_OWNER_PHONE = "GuardTrackerBleControlActivity.OWNER_PHONE";
    ...
    private GuardTrackerSyncConfigWorkflow mSyncWorkflow;
...
//    }
    ...
    public void onAuthenticated() {
        ...
        try {
            ...
            // First synchronization
            mSyncWorkflow = new GuardTrackerSyncConfigWorkflow(mBleConnControl, this);
            updateLogArea("Pair with new device");
            updateLogArea("Sync first time");
    ...
    /*
     * GuardTrackerSyncConfigListener implementation
     */
    @Override
...
//    }
    ...
    private void startGuardTrackerView(int guardTrackerId) {
        ...
        Intent intent = new Intent(GuardTrackerBleControlActivity.this, GuardTrackerActivity.class);
