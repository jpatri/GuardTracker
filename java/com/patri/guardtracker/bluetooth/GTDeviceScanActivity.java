...
import com.patri.guardtracker.PhonePickerNeverAskAgainDialogFragment;
 ...
 */
public class GTDeviceScanActivity extends AppCompatActivity implements DialogListener {
    private final static String TAG = GTDeviceScanActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final Intent intent = new Intent(GTDeviceScanActivity.this, GTDeviceControlActivity.class);
                ...
                intent.putExtra(GTDeviceControlActivity.EXTRAS_DEVICE_OWNER_PHONE, mSelfPhoneNumber);
                if (mScanning) {
        ...
        phoneDialog.show(getSupportFragmentManager(), "PhonePickerNeverAskAgainDialogFragment");
...
//    }
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public LeDeviceListAdapter() {
            ...
            mInflator = GTDeviceScanActivity.this.getLayoutInflater();
        }
...
//                view.setTag(viewHolder);
    ...
    public void onDialogPositiveClick(DialogFragment dialog) {
        PhonePickerNeverAskAgainDialogFragment phonePickerDialog = (PhonePickerNeverAskAgainDialogFragment)dialog;
        mSelfPhoneNumber = phonePickerDialog.getPhoneNumber();
        mNeverAskAgain = phonePickerDialog.isNeverAskAgainChecked();
        scanLeDevice(true);
        // Todo: register selfPhoneNumber to use it next time it is needed.
        dialog.dismiss();
    }
}